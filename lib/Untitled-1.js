...
(function () {
    ...
    Internal.curve25519 = {
        keyPair: function (privKey) {
            ...
            var err = crypt._curve25519_donna(
                publicKey_ptr,
                privateKey_ptr,
                basepoint_ptr
            );
        ...
        sign: function (privKey, message) {
            ...
            var err = crypt._curve25519_sign(
                signature_ptr,
                privateKey_ptr,
                message_ptr,
                message.byteLength
        ...
        verify: function (pubKey, message, sig) {
            ...
            var res = crypt._curve25519_verify(
                signature_ptr,
                publicKey_ptr,
                message_ptr,
                message.byteLength
...
function validatePrivKey(privKey) {
    if (
        privKey === undefined ||
        !(privKey instanceof ArrayBuffer) ||
        privKey.byteLength != 32
    ) {
...
function processKeys(raw_keys) {
    ...
    return { pubKey: origPub.buffer, privKey: raw_keys.privKey };
}
